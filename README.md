...
```sh
git clone https://github.com/CristianoFIlho/animation-menu.git
```
...
[https://github.com/CristianoFIlho/animation-menu.git](https://github.com/CristianoFIlho/animation-menu.git)

## 🧙‍♂️ Contribution

1. Make the _fork_ of the project (<hhttps://github.com/CristianoFIlho/animation-menu.git/fork>)
